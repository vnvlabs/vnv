...
class plotJs(VVParser):
    ...
    def parse(self) :
        ...
        text = "renderExampleLineChart(\"" + divId + "\");"
    ...
    def requires(self):
        return ["js/charts.js", "js/myChart.js"]
...
class plot3D(VVParser):
    ...
    def parse(self) :
        ...
        # Build the element 
        et = etree.Element("div")
        ett = etree.SubElement(et,"div")       
        ett.set("class","content")
        ettt= etree.SubElement(et,"script")
        ettt.set("src","js/VolumeViewer.js")
        
        print( etree.tostring(et)) 
        
        return et, getScriptTag("")

    def requires(self):
        return []


registerParser("plot3D",plot3D)
...
def getMarkdown(string, adios):
    ...
    global REQUIRED_JS_SCRIPTS
    global CUSTOM_JS_SCRIPTS
