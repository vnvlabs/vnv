...
const double PI = 3.1415926535;
 ...
 /**
   ...
   *    }
   *
   * Plot of the forward finite difference numerical derivative of sine. This is a mesh of 100 elements. The true cosine is also plotted for reference.
   *
   * .. vnv-plotly::
 ...
 * 
 */
INJECTION_OPTIONS(FiniteDifferenceDerivative,"{}") {
  return NULL;
}
...
int main(int argc, char** argv) {
    ...
    INJECTION_INITIALIZE(FiniteDifferenceDerivative, &argc, &argv, (argc == 2) ? argv[1] : "./inputfiles/finiteDifferenceDerivative.json");
 ...
 /**
   ...
   * @description Plots sine, cosine, and the numerical derivative of sine. This derivative is calculated through a 1st-order finite difference method.
   * 
   * Plots sine, cosine, and the numerical derivative of sine. This derivative is calculated through a 1st-order finite difference method.
   * 
   **/
    INJECTION_POINT(FiniteDifferenceDerivative, VWORLD, mainpoint, phase_vals, sine_vals, cosine_vals, mesh_phase_vals, mesh_cosine_vals, diff_cosine_vals);
