...
program hello
  ...
  call vnv_initialize("fortran","./vv-input.json", vnv_fortran_registration())
  ...
  call vnv_input_file(1,"fortran","inputs","./inputs.json","json")
  ...
  call vnv_input_file(1,"fortran","inputs","./inputs.text","auto")

  ! The same interface works for output files. 
  call vnv_output_file(1,"fortran","inputs","./inputs.json","json")
