...
TYPES_MAP = {
    ...
    '_Projection': 'array',
    '_Expression': 'expref',
   'OutputReader.RootNode' : 'object',
   'OutputReader.UnitTestNode' : 'object',
   'OutputReader.UnitTestResultsMap' : 'object',
   'OutputReader.Node' : 'object',
   'OutputReader.DocumentationNode' : 'object',
   'OutputReader.LogNode' : 'object',
   'OutputReader.InjectionPointNode' : 'object',
   'OutputReader.TestNode' : 'object',
   'OutputReader.InfoNode' : 'object',
   'OutputReader.DataNode' : 'object',
...
object_types = (
   ...
   'OutputReader.Node' ,
   'OutputReader.DocumentationNode' ,
...
array_types = ("OutputReader.TestNodeArray","OutputReader.DataArray","OutputReader.ChildrenArray","OutputReader.UnitTestArray","list", "_Projection",)
...
class Functions(with_metaclass(FunctionRegistry, object)):
    ...
    def _func_type(self, arg):
        if isinstance(arg, STRING_TYPE):
            ...
            return "null"
        elif hasattr(arg,"__getType__"):
            return arg.__getType__()
