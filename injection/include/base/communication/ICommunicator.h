...
namespace VnV
{
  ...
  public:
    ...
    virtual void set(VnV_Comm comm) = 0; // The communicator passed in.
    virtual VnV_Comm get() = 0;          // Data is everything needed to rebuild this communicator.
    ...
    virtual ICommunicator_ptr custom(VnV_Comm comm) = 0;
  ...
  typedef ICommunicator *(*comm_register_ptr)(VnVCommType);
...
#define INJECTION_COMM(PNAME, name)                                \
  ...
  {                                                                \
    ...
    {                                                              \
      ...
      {                                                            \
        VnV::ICommunicator *declare_##name(VnV::VnVCommType type); \
      }                                                            \
    }                                                              \
  }                                                                \
  VnV::ICommunicator *VnV::PNAME::Communication::declare_##name(VnV::VnVCommType type)
