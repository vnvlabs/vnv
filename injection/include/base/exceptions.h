...
#define INJECTION_EXCEPTION(format, ...) \
   VnV::VnVExceptionBase(__FUNCTION__,__FILE__,__LINE__,format, __VA_ARGS__)


#define INJECTION_EXCEPTION_(format) \
   VnV::VnVExceptionBase(__FUNCTION__,__FILE__,__LINE__,format)

#define _INJECTION_EXCEPTION(format, ...) \
   VnVExceptionBase(__FUNCTION__,__FILE__,__LINE__,format, __VA_ARGS__)



#define INJECTION_BUG_REPORT_(format) \
   VnV::VnVBugReport(__FUNCTION__,__FILE__,__LINE__,format)

#define INJECTION_BUG_REPORT(format, ...) \
   VnV::VnVBugReport(__FUNCTION__,__FILE__,__LINE__,format, __VA_ARGS__)
