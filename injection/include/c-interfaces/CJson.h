...
EXTERNC void VnV_CJson_getKeyValue(c_json json, char* key, c_json* result,
                                   int* err);
EXTERNC void VnV_CJson_hasKey(c_json json, char* key, bool* result, int* err);
EXTERNC void VnV_CJson_getAllKeys(c_json json, char*** keys, int* size,
                                  int* err);
EXTERNC void VnV_CJson_freeAllKeys(c_json json, char*** keys, int* size,
                                   int* err);
EXTERNC void VnV_CJson_is_array(c_json json, bool* result, int* err);
EXTERNC void VnV_CJson_getArraySize(c_json json, unsigned long* result,
                                    int* err);
EXTERNC void VnV_CJson_getArrayIndex(c_json json, unsigned int index,
                                     c_json* result, int* err);
...
EXTERNC void VnV_CJson_getUnsignedInt(c_json json, unsigned int* result,
                                      int* err);
...
EXTERNC void _VnV_registerOptions(const char* packageName, const char* sptr,
                                  options_callback_ptr* ptr);
