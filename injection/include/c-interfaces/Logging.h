...
#define REGISTERLOGLEVEL(NAME,COLOR) _VnV_registerLogLevel(PACKAGENAME_S,#NAME,#COLOR);
...
#define VnV_Log_MPI(comm, level,...) _VnV_Log(comm,PACKAGENAME_S,level,__VA_ARGS__)
