...
#define X(type) VNVEXTERNC void VnV_Output_Put_##type(VnV_Comm comm, struct IOutputEngineWrapper *wrapper, const char* name, type* value);
OUTPUTENGINESUPPORTEDTYPES
#undef X

VNVEXTERNC void VnV_Output_Put_String(VnV_Comm comm, struct IOutputEngineWrapper *wrapper, const char *name, const char* value);
...
typedef void (*injectionDataCallback)(VnV_Comm comm, struct ParameterSetWrapper *wrapper, struct IOutputEngineWrapper *engine );
