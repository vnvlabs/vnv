...
class ICommunicator {
 ...
 public:
  ...
  virtual void*
  getData() = 0;  // Data is everything needed to rebuild this communicator.
  ...
  virtual void GatherV(void* buffer, int count, void* recvBuffer,
                       int* recvCount, int* recvDispl, int dataTypeSize,
                       int root) = 0;
  virtual void AllGatherV(void* buffer, int count, void* recvBuffer,
                          int* recvCount, int* recvDispl, int dataTypeSize) = 0;
