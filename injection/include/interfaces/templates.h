...
#define VNV_TEMPLATE_1(NAME, PARAM, CALLBACK) VNV_TEMPLATE_(one, NAME, PARAM, CALLBACK)

#define VNV_TEMPLATE_2(NAME, PARAM, ...) VNV_TEMPLATE_(two, NAME, PARAM, VNV_TEMPLATE_1(__VA_ARGS__))

#define VNV_TEMPLATE_3(NAME, PARAM, ...) VNV_TEMPLATE_(three, NAME, PARAM, VNV_TEMPLATE_2(__VA_ARGS__))

#define VNV_TEMPLATE_4(NAME, PARAM, ...) VNV_TEMPLATE_(four, NAME, PARAM, VNV_TEMPLATE_3(__VA_ARGS__))

#define VNV_TEMPLATE_5(NAME, PARAM, ...) VNV_TEMPLATE_(five, NAME, PARAM, VNV_TEMPLATE_4(__VA_ARGS__))

#if TESTING
VNV_TEMPLATE_5(a, a1, b, b1, c, c1, d, d1, e, e1, { printf("TGFSDG"); })
#endif
...
#if TESTING
VNV_TEMPLATE_1_4({ printf("Hello"); }, { printf("THERE"); }, "a", double, float, int, double);
#endif
...
#if TESTING
VNV_TEMPLATE_2_2({
  printf("Hello");}, {printf{"THERE"}, "a","b", double, float, int, double);
#endif
