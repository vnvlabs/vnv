...
class SparseBitVector {
    ...
    ElementListIter FindLowerBoundImpl(unsigned ElementIndex) const {
        ...
        ElementListIter End =
                const_cast<SparseBitVector*>(this)->Elements.end();
...
public:
    ...
    SparseBitVector() :
            Elements(), CurrElementIter(Elements.begin()) {
    }

    SparseBitVector(int idx) :
            Elements(), CurrElementIter(Elements.begin()) {
        set(idx);
    }
    ...
    void intersectWithComplement(const SparseBitVector &RHS1,
        ...
        while (Iter2 != RHS2.Elements.end()) {
            ...
            if (Iter1->index() > Iter2->index()) {
                ...
                Elements.back().intersectWithComplement(*Iter1, *Iter2,
                        BecameZero);
                if (BecameZero)
                    Elements.pop_back();
                ++Iter1;
...
template<unsigned ElementSize>
inline SparseBitVector operator|(
        const SparseBitVector &LHS,
        const SparseBitVector &RHS) {
