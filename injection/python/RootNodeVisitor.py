...
import ModifiedFunctions as functions
...
class RootInterpreter(RootNodeVisitor):
    COMPARATOR_FUNC = {
        'eq': _equals,
    ...
    def isDefactoList(self, element):
        return isinstance(element,list) or ( hasattr(element,"__getType__") and element.__getType__() == "list" )
    ...
    def visit_index(self, node, value):
        ...
        print("HERE", value, node , isinstance(value,list))
