...
void VnV_Declare_Communicator(const char* packageName, const char* commPackage, const char* commName){
  VnV::CommunicationStore::instance().declareComm(packageName,commPackage,commName);
}
