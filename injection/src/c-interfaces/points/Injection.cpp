...
void _VnV_injectionPoint(VnV_Comm comm, const char* package, const char* id,const char* fname, int line,
...
void _VnV_injectionPoint_begin(VnV_Comm comm, const char* package,const char* fname, int line,
...
void _VnV_injectionPoint_loop(const char* package, const char* id,
                              const char* stageId, const char* fname, int line) {
  VnV::RunTime::instance().injectionPoint_iter(package, id, stageId, fname, line);
}

int _VnV_injectionPoint_end(const char* package, const char* id, const char* fname, int line) {
