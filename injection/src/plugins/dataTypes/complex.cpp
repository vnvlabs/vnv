...
template <typename T> class GenericDataType : public IDataType {
 ...
 public:
  ...
  void* getPutData(int iteration) override { return &data; }
};

template <unsigned int N, typename T> class StringDataType : public IDataType {
 public:
  T data;
