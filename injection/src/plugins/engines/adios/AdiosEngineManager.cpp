...
void AdiosEngineManager::Put(VnV_Comm, std::string variableName, const double &value) {
    engine.Put(variableName, value);
}

void AdiosEngineManager::Put(VnV_Comm, std::string variableName, const int &value) {
    engine.Put(variableName, value);
}

void AdiosEngineManager::Put(VnV_Comm, std::string variableName, const float &value) {
    engine.Put(variableName, value);
}

void AdiosEngineManager::Put(VnV_Comm, std::string variableName, const long &value) {
    engine.Put(variableName, value);
}

void AdiosEngineManager::Put(VnV_Comm, std::string variableName, const bool &value) {
    const int val = value;
    engine.Put(variableName, val);
}

void AdiosEngineManager::Put(VnV_Comm, std::string variableName, const nlohmann::json &value){
    engine.Put(variableName, value.dump());
}

void AdiosEngineManager::Put(VnV_Comm, std::string variableName, const std::string &value) {
    engine.Put(variableName, value);
}

void AdiosEngineManager::Log(VnV_Comm, const char *package, int stage, std::string level, std::string message) {
...
void AdiosEngineManager::injectionPointEndedCallBack(VnV_Comm, std::string id, InjectionPointType type_, std::string stageId) {
    if (engine) {
        engine.BeginStep();
...
void AdiosEngineManager::injectionPointStartedCallBack(VnV_Comm, std::string id, InjectionPointType type_, std::string stageId) {
    if (engine) {
        engine.BeginStep();
        engine.Put(identifier, id);
        std::string ss = InjectionPointTypeUtils::getType(type_,stageId);
...
void AdiosEngineManager::unitTestStartedCallBack(VnV_Comm, std::string unitTestName) {
    if (engine) {
        engine.BeginStep();
...
std::string AdiosEngineManager::print() {
    return "Adios Engine Manager" ;
}
