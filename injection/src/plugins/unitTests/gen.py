...
def addToCmake(fname, runFile ):
    ...
    with open(runFile, "r") as f:
       ...
       dec = "target_sources(injection PRIVATE \"${CMAKE_CURRENT_LIST_DIR}/" + fname + "\")\n" + cmake_needle
...
if len(sys.argv) == 2:
    ...
    addToRunner("./UnitTestRegistration.cpp", name, fname)
    ...
    removeFromRunner("./UnitTestRegistration.cpp", name, fname, True)
    if True:
       os.remove(fname)
    else: 
