...
function(GitStateChangedAction)
    ...
    message("SDFSDF ${CMAKE_CXX_COMPILER} sdfsdf")
...
function(SetupGitMonitoring)
    add_custom_target(check_git
        ...
        COMMAND
            ...
            -DVNV_C_COMPILER=${CMAKE_C_COMPILER}
            -DVNV_C_COMPILER_VERSION=${CMAKE_C_COMPILER_VERSION}
            -DVNV_CXX_COMPILER=${CMAKE_CXX_COMPILER}
            -DVNV_CXX_COMPILER_VERSION=${CMAKE_CXX_COMPILER_VERSION}
            -DVNV_MPI_C_COMPILER=${MPI_C_COMPILER}
            -DVNV_MPI_C_VERSION=${MPI_C_VERSION}
            -DVNV_MPI_CXX_COMPILER=${MPI_CXX_COMPILER}
            -DVNV_MPI_CXX_VERSION=${MPI_CXX_VERSION}
