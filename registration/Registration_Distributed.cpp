...
INJECTION_REGISTRATION(Distributed){
	...
	Register_Injection_Point("Distributed","distribute","{\"local_mat\":\"std::vector<std::vector<double>>\",\"local_vec\":\"std::vector<double>\"}");
