...
DECLAREENGINE(VNV,adios_file)
DECLAREENGINE(VNV,json_file)
DECLAREENGINE(VNV,json_http)
DECLAREENGINE(VNV,json_socket)
DECLAREENGINE(VNV,json_stdout)
DECLAREUNITTEST(VNV,CommMapTester)
DECLAREUNITTEST(VNV,CommTestTwoProc)
DECLAREUNITTEST(VNV,Sample2)
DECLAREACTION(VNV,BuildAndServe)
...
INJECTION_REGISTRATION(VNV){
	...
	REGISTERENGINE(VNV,adios_file);
	REGISTERENGINE(VNV,json_file);
	REGISTERENGINE(VNV,json_http);
	REGISTERENGINE(VNV,json_socket);
	REGISTERENGINE(VNV,json_stdout);
	REGISTERUNITTEST(VNV,CommMapTester);
	REGISTERUNITTEST(VNV,CommTestTwoProc);
	REGISTERUNITTEST(VNV,Sample2);
	REGISTERACTION(VNV,BuildAndServe);
